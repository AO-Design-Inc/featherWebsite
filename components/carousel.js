...
class ImageCarousel extends HTMLElement {
    ...
    connectedCallback() {
        ...
        // this isn't getting the image size 😩
        window.onload=()=>{
          console.log("shit loaded");
          this.imagesize = this.parentNode.offsetWidth;
        ...
        this.shadowRoot.querySelector(".carousel-next").addEventListener("click", ()=>{
          ...
          if (parseInt(this.slideno) == (this.length-1)) {
            this.slideno = 0;
          } else {
        ...
        window.addEventListener("resize", ()=>{
          window.requestAnimationFrame(()=>{
            ...
            slide.style.transform = `translateX(${-(this.imagesize) * this.slideno}px)`;
          });
        });
