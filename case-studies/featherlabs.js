let featherlabsString = `
<template id="featherlabs">
    <dash-board action="email"></dash-board>
    <div id="splash" class="image-cover" style="background-image: url('./case-studies/assets/thumbnails/labs_splash.png.webp');">
    ...
    <div id="section-container">
        ...
        <div class="section">
            ...
            <p class="section-title">4 Results</p>
...
class featherlabsPage extends HTMLElement{
    constructor() {
        super();
    }
    ...
    connectedCallback() {
        ...
        var templateHtml = parser.parseFromString(featherlabsString, 'text/html');

        // get the template contents
        var template = templateHtml.getElementById('featherlabs');
...
customElements.define('featherlabs-page', featherlabsPage);
